...
/**
 * ALIPAY API: alipay.trust.user.riskidentify.nontoken.get request
 *
 * @author auto create
 * @since 1.0, 2019-03-08 15:29:11
 */
class AlipayTrustUserRiskidentifyNontokenGetRequest
{
	/** 
	 * 入参json串
	 **/
	...
	{
		return "alipay.trust.user.riskidentify.nontoken.get";
	}
