<?php
namespace Shiqc\AliSDK\MiniProgram\Auth;
...
class ServiceProvider
{
	...
	{
		self::$rsaPrivateKey=file_get_contents(storage_path(config('shiqc-alisdk.APP_PRIVATE_KEY')));
		self::$alipayrsaPublicKey = file_get_contents(storage_path(config('shiqc-alisdk.ALIPAY_PUBLIC_KEY')));
	}
	/**
	 * 获取私钥
